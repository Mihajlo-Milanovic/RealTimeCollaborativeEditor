...
function VerifyPage() {
    ...
    (0, react_1.useEffect)(function () {
        ...
        var verify = function () { return __awaiter(_this, void 0, void 0, function () {
            var res, verifyRes, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, fetch("http://localhost:5000/user/getUserByVerificationToken?verificationToken=".concat(token))];
                    case 1:
                        res = _a.sent();
                        if (!res.ok) {
                        ...
                        return [4 /*yield*/, fetch("http://localhost:5000/user/verifyUser?verificationToken=".concat(token))];
                    case 2:
                        verifyRes = _a.sent();
                        if (verifyRes.ok) {
